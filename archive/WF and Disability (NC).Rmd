...
```{r}
data3 <- data3 %>% mutate(svi=E_D, WF=MEA, ratio=(WF/svi))
```
...
map <- ggplot() +
  ...
  labs(
    title = "Wildfire Risk on Important Watersheds and Disabled Persons Presence",
    caption = "Wildfire risk to important watersheds data from Forest to Faucets (https://www.fs.fed.us/ecosystemservices/FS_Efforts/forests2faucets.shtml);\nLevel of disabled persons presence from the Social Vulnerability Index (https://www.atsdr.cdc.gov/placeandhealth/svi/index.html)."
  ) +
